      ...
      <CardHeader className="pb-3 border-b flex-shrink-0 flex flex-row items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            {verificationStatus === "verified_true" && <Badge className="bg-green-600 text-white">Verified True</Badge>}
            {verificationStatus === "verified_false" && <Badge className="bg-red-600 text-white">Verified False</Badge>}
            {verificationStatus === "unverified" && <Badge variant="outline">Unverified</Badge>}
          </div>
        </div>
        <button
          onClick={onClose}
      ...
      <CardContent className="flex-1 overflow-y-auto space-y-4 pt-4">
            ...
            <div className="space-y-2 text-xs">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="font-semibold">{tweet.aiReport.credibilityScore}%</span>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed">{tweet.aiReport.analysis}</p>
              <div>
                <p className="text-muted-foreground font-semibold mb-2">Sources Researched</p>
        ...
        {verificationStatus === "unverified" ? (
            ...
            <Tabs defaultValue="ai" className="w-full">
              ...
              <TabsContent value="ai" className="space-y-3 mt-3">
                <p className="text-xs text-muted-foreground">
                  Review the AI analysis above and choose to verify as true or false
                </p>
              ...
              <TabsContent value="manual" className="space-y-3 mt-3">
                {!showManualVerification ? (
                  <>
                    ...
                    <Button onClick={() => setShowManualVerification(true)} className="w-full bg-primary text-xs">
                      <Settings className="w-3 h-3 mr-1" />
                  ...
                  <>
                    <div className="bg-muted/50 rounded-lg p-3 mb-3">
                      <h5 className="font-semibold text-xs mb-2">Poster Information</h5>
                      <div className="space-y-2 text-xs">
                        <div>
                    ...
                    >
                      <Button variant="outline" className="w-full text-xs mb-3 bg-transparent">
          ...
          <div className="space-y-3 border-t pt-3">
            ...
            {!isSentToAdmin && (
              <Button onClick={onSendToAdmin} className="w-full bg-secondary hover:bg-secondary/90 text-xs">
